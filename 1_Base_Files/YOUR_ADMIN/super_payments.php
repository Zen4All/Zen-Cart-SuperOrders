...
if ($_GET['process'] == '1') {
  ...
  <html <?php echo HTML_PARAMS; ?>>
    <head>
      ...
      <script src="includes/formval.js"></script>
      <script>
        ...
        function validateOnSubmit() {
            ...
            if (!validateTelnr(document.forms.demo.telnr, 'inf_telnr', true))
                errs += 1;
            if (!validateAge(document.forms.demo.age, 'inf_age', false))
                errs += 1;
            if (!validateEmail(document.forms.demo.email, 'inf_email', true))
                errs += 1;
            if (!validatePresent(document.forms.demo.from, 'inf_from'))
                errs += 1;
